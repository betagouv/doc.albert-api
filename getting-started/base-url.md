...
{% hint style="warning" %}
⚠️ À vérifier — Politique précise de dépréciation, période de grâce et calendrier des évolutions : consulter les canaux officiels et le [Changelog](../resources/changelog.md).
{% endhint %}
...
Pour le détail des chemins et schémas : [Référence OpenAPI](../api-reference/reference.md).
