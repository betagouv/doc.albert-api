...
- **OpenAPI 3.1 :** [Référence OpenAPI interactive](../api-reference/reference.md) (fichier `openapi.json` à la racine du même hôte)

## Prochaines étapes

1. [Authentification](authentication.md) — en-tête Bearer et obtention d’un jeton.
2. [Démarrage rapide](quickstart.md) — premier appel `POST /v1/chat/completions`.
