...
La structure exacte de la réponse (scores, indices) est définie dans le schéma de réponse associé à l’opération `rerank` dans la [Référence OpenAPI](../api-reference/reference.md).
