...
{% hint style="warning" %}
⚠️ À vérifier — Clés exactes supportées dans `stream_options` et compatibilité `include_usage` selon les modèles : consulter le schéma `CreateChatCompletion` et les notes de version dans la [Référence OpenAPI](../api-reference/reference.md).
{% endhint %}
...
- **Erreurs mid-stream** : traiter les erreurs HTTP comme sur les appels non streamés ; voir [Codes d'erreur](../resources/errors.md).
