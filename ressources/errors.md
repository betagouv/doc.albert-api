...
Utilisée notamment pour les réponses **503** de type _« Model is too busy »_ sur `POST /v1/chat/completions` et `POST /v1/ocr` :
...
| **503** | Service Unavailable | Saturation modèle : message _« Model is too busy, please try again later. »_               |
...
Pour une cartographie complète des réponses par route : [Référence OpenAPI](/broken/pages/vRZwVxl3vzeW4GecHnw7).
